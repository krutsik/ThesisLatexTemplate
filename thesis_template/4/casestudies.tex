...
\textbf{\textit{Setup and Methodology:}} 

To validate our hypothesis, we compare how our proposed solution is more effective than traditional advertisement frameworks. As a result, we develop one use case based on a Wikipedia app, which implements our library. This application is selected because our mechanisms targets applications that present content to the user, e.g., news, feeds, text, etc. 

Initially, we integrate the wikipedia app with traditional advertisement mechanism as shown in Figure\ref{fig:ads1}

Next, we instrumentalize the same wikipedia app, but this time with our proposed solution. 
...
\begin{figure}
\begin{center}
\includegraphics[width=0.5]{Images/gesturead_big1.png}
